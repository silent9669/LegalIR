...
def build_legalir_notebook() -> dict:
    ...
    cell_2 = {
        ...
        "source": [
            ...
            "]\n",
            "\n",
            "EXPECTED_COMMIT = os.environ.get(\"LEGALIR_COMMIT_SHA\", \"1817e712542871469851dffd63637e91fa417af4\")\n",
            "REPO_ROOT = None\n",
    ...
    cell_3 = {
        ...
        "source": [
            ...
            "\n",
            "# Lightweight Parquet metadata row counts (zero duplicate 770MB table RAM materialization)\n",
